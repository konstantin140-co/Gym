...
internal static class UiTheme
{
    ...
    public static Color AccentHover => Color.FromArgb(185, 28, 28);
    ...
    public static (Color Top, Color Bottom) NavHoverGradient => Current == AppTheme.Light
        ? (Color.FromArgb(80, 254, 226, 226), Color.FromArgb(50, 254, 202, 202))
    ...
    public static (Color Top, Color Bottom) NavActiveGradient => Current == AppTheme.Light
        ? (Color.FromArgb(130, 254, 202, 202), Color.FromArgb(80, 252, 165, 165))
        : (Color.FromArgb(70, 185, 28, 28), Color.FromArgb(45, 127, 29, 29));

    public static Color SidebarBackground => NavBackground;
    public static Color SidebarActive => NavActive;
    public static (Color Top, Color Bottom) SidebarHoverGradient => NavHoverGradient;
    public static (Color Top, Color Bottom) SidebarActiveGradient => NavActiveGradient;
